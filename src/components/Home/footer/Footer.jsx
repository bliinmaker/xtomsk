const Footer = () => {
	return (
        <>
                ...
                <div className='box-container'>
                    ...
                    <div className='box' data-aos='fade-up' data-aos-delay='300'>
                        ...
                        <a href='#about' className='links'>
                            <i className='fas fa-arrow-right'></i>о нас
                        </a>
                        <a href='#services' className='links'>
                            <i className='fas fa-arrow-right'></i>услуги
                        </a>
                        <a href='#destination' className='links'>
                            <i className='fas fa-arrow-right'></i>экскурсии
                        </a>
                    </div>
            ...
            <div className="credit">coded by <span>the kinozemts</span> | all rights reserved</div>
        </>
	)
}
